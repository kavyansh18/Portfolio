          ...
          >
            ...
            <CardContainer className="inter-var flex-shrink-0">
              <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] lg:w-[27rem] w-[22rem] lg:h-auto h-[32rem] rounded-xl p-5 border">
                ...
                >
                  StakeRich: Discover the DEX build on trust!
                </CardItem>
                <CardItem
                  as="p"
                  translateZ="60"
                ...
                >
                  Decentralized staking dApp that lets users stake tokens into on-chain pools and earn rewards with a clean, wallet-connected interface. It provides a simple dashboard to view stakes, track returns, and manage positions while keeping full custody of funds.
                ...
                <div className="flex justify-between items-center mt-5">
                  <CardItem
                    translateZ={20}
                    as={Link}
                    to="https://stake-rich.vercel.app/"
                    target="_blank"
                  ...
                  <CardItem
                    translateZ={20}
                    as={Link}
                    to="https://github.com/kavyansh18/StakeRich"
                    target="_blank"
