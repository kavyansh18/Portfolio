...
const Skeleton03 = () => {
  return (
    <div>
      ...
      <p className="font-normal my-4 max-w-lg text-neutral-200 text-sm lg:text-m">
       Clicked at the Solana Hacker House Bengaluru'24
      </p>
    </div>
  );
};
...
const Skeleton02 = () => {
  return (
    <div>
      ...
      <p className="font-normal text-base text-white"></p>
      <p className="font-normal my-4 max-w-lg text-neutral-200 text-sm lg:text-m">
       Interacting and learning a lot from seniors and ofc with fun at SHH'24
      </p>
    </div>
  );
};
...
const Skeleton01 = () => {
  return (
    <div>
      <p className="font-bold md:text-4xl text-xl text-white">
        The squad everywhere I go
      </p>
      <p className="font-normal text-base text-white"></p>
      <p className="font-normal my-4 max-w-lg text-neutral-200 text-sm lg:text-m">
       Best people to be arround and build together
      </p>
    </div>
  );
};
...
const Skeleton0 = () => {
  return (
    <div>
      ...
      <p className="font-normal text-white text-sm"></p>
      <p className="font-normal my-4 max-w-lg text-neutral-200 text-sm lg:text-m">
